...
const slides = [
    /* Should be simple to add events to the slide show. Just follow the format image:"<image_path>", imageWidth/imageHeight: "<real pixel dimensions of the image file, prevents layout shift>", title: "<title>", date: "<date>", description: ["<description>"] } */

    { image: "/hero/hero01.JPG", imageWidth: 6000, imageHeight: 4000, title: "Kickoff Event", date: "October 21, 2025", description: [
    ...
    { image: "/events/bowling/bowling01.JPG", imageWidth: 4951, imageHeight: 3301, title: "Bowling Night", date: "November 19, 2025", description: ["We ended the semester with our BSCS x NSBE bowling night and it was a successful one. Thanks to everyone who joined!",
        "Follow us for more exciting events happening next year 🥰"
    ]},

    { image: "/events/github/github01.JPG", imageWidth: 3941, imageHeight: 2627, title: "Github Workshop", date: "January 27, 2026", description: ["We hosted our GitHub Workshop: Coder to Contributor, and it was a massive success! A huge shoutout to our incredible mentors who spent the afternoon floating around the room, troubleshooting bugs, and helping everyone get their first pull requests through.",
        "We’re all about students helping students and seeing that collaboration in action was the highlight of the day. 🧱✊🏾"
        ]},

    { image: "/hero/movienight.jpg", imageWidth: 1206, imageHeight: 1074, title: "Movie Night" , date: "February 11, 2026", description: ["We had a blast at our BSCS Movie Night! 🎬🍿 Thanks to everyone who joined us for an evening of fun, laughter, and great company."]},

    { image: "/hero/careersesh01.jpg", imageWidth: 1800, imageHeight: 1350, title: "Career Sesh", date: "March 28, 2026", description: ["What an incredible day at the BSCS Career Event! 🌟 Grateful to our inspiring speakers, supportive sponsors, and amazing team for making this possible.",
        "The insights shared and connections made are stepping stones for all of us in tech. 💻✨"
    ]},

    { image: "/hero/potluck.jpg", imageWidth: 1206, imageHeight: 1234, title: "Potluck", date: "April 21, 2026", description: ["We took over the BSI Lounge with music, games, and food to end the semester.",
